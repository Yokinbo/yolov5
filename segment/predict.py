...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default="/mnt/e/YOLO/yolov5/runs/train-seg/exp6/weights/best.pt", help="model path(s)")
    parser.add_argument("--source", type=str, default="/mnt/e/YOLO/yolov5/data/enhancedata/images/test", help="file/dir/URL/glob/screen/0(webcam)")
