...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default="/mnt/e/YOLO/yolov5/weight/yolov5m-seg.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="/mnt/e/YOLO/yolov5/models/segment/yolov5m-seg.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="/mnt/e/YOLO/yolov5/data/co128-seg copy.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
    parser.add_argument("--epochs", type=int, default=100, help="total training epochs")
    parser.add_argument("--batch-size", type=int, default=16, help="total batch size for all GPUs, -1 for autobatch")
    parser.add_argument("--imgsz", "--img", "--img-size", type=int, default=460, help="train, val image size (pixels)")
